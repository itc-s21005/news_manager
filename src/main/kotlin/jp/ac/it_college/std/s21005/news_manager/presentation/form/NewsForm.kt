package jp.ac.it_college.std.s21005.news_manager.presentation.form

import jp.ac.it_college.std.s21005.news_manager.domain.model.NewsWithCategoryModel
import jp.ac.it_college.std.s21005.news_manager.infrastructure.database.record.CategoryRecord
...
data class CategoryInfo(
    ...
    constructor(categoty: CategoryRecord) : this(categoty.id!!, categoty.name!!)
}
